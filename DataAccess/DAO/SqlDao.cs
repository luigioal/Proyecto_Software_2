...
namespace DataAccess.DAO
{
    public class SqlDao
    {
        ...
        private SqlDao()
        {
            ...
            _connectionString = "Server=tcp:employee-perks-wilmer-server.database.windows.net,1433;Initial Catalog=Proyecto_Software_2_DB;Persist Security Info=False;User ID=lavarus;Password=W.w72v8siFVP7..;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=300;";//Environment.GetEnvironmentVariable("DB_CONNECTION_STRING");
